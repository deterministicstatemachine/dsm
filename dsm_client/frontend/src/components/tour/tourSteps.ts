...
export const TOUR_STEPS: ReadonlyArray<TourStep> = [
  ...
  },
  {
    id: 'go-sofi',
    screen: 'home',
    target: '.dsm-menu-item[data-label="SOFI"]',
    menuItem: 'SOFI',
    title: 'SoFi',
    body: 'Now SOFI. Tap it.',
  ...
  },
  {
    id: 'sofi-menu',
    screen: 'sofi',
    target: '[aria-label="SoFi sub-menu"]',
    title: 'Sovereign finance',
    body: 'Trades, vaults and mail that settle straight between devices, with no exchange in the middle. Swap trades at a vault\'s price, Liquidity earns a vault\'s fee, and Mail leaves a note on the storage nodes for someone to pick up.',
  },
  {
    id: 'info',
    screen: 'sofi',
    target: '.sb-screen__head .sb-info',
