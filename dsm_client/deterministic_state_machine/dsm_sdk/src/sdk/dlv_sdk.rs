...
//! - SPHINCS+ signing authority is derived from the canonical device-birth binding.
...
pub struct UnlockOptions {
    ...
    /// If `None`, the SDK derives the current canonical device-birth-bound signing public key.
...
mod tests {
    ...
    fn install_test_identity() -> Vec<u8> {
        ...
        crate::set_device_birth_binding_key_for_testing(TEST_BINDING_KEY.to_vec());
        public_key
    }
