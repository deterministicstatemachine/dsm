...
// wire it through the SDK with generated proto messages and prost encoding.
compile_error!("blockchain_transport (JSON/Web3) removed: implement a protobuf-based transport if needed");
