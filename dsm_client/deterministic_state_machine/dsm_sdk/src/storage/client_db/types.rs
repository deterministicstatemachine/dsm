...
pub struct GenesisRecord {
    ...
    /// Base32-Crockford device-birth nonce commitment generated by the SDK at
    /// genesis. Finalize/restore re-derive `AttA` from it (folded verbatim into
    /// `DeviceBirthInputs::from_platform_nonce`), so this column is the durable
    /// source of the per-install binding — never a host-supplied value.
