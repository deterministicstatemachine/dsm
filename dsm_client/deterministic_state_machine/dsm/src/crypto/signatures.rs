...
mod tests {
    ...
    fn default_entropy_keypair_digest_is_stable() {
        ...
        assert_eq!(
            pk_digest,
            [
                236, 23, 150, 97, 121, 151, 231, 49,
                137, 242, 102, 79, 185, 13, 132, 232,
                170, 132, 189, 216, 124, 118, 71, 87,
                182, 168, 208, 245, 46, 79, 201, 96,
            ]
        );
        assert_eq!(
            sk_digest,
            [
                136, 152, 136, 166, 60, 168, 196, 13,
                64, 154, 36, 9, 16, 132, 236, 213,
                143, 244, 113, 186, 132, 38, 108, 122,
                25, 110, 74, 26, 87, 32, 211, 39,
            ]
        );
    }
