...
/// `AddDeviceAdmission` — the joining device signs this with its device-birth-bound device key to prove
/// physical possession of its claimed identity (without revealing the raw device-birth).
